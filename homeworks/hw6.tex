...
\begin{hwexercise} Let $T^2 \to S^1$ be the torus, viewed as an $S^1$-bundle over $S^1$, with structure group $C_2$ given by rotating the circles in the fibers 180 degrees. Let $T^2_\text{twist} \to S^1$ be a similar fiber bundle, but where we cut the original one, turn one end of it 180 degrees and reglue it. Let $T^2 \to T^2_\text{twist}$ be this process of cutting, twisting, and regluing.
\begin{enumerate}
    \item Is the map $T^2 \to T^2_\text{twist}$ as described above a homeomorphism of $S^1$-fiber bundles with structure group $C_2$ over $S^1$?
